OPTC Checklist allow to generate csv file to track characters in the One Piece Treasure Cruise game.

`character_log` : list based on the Global version character log.
`checklist_banner_only` : list of characters non farmable.
`upgrade_tracker` : list of best form of a non farmable character to track limit breack progression.
